...
if __name__ == "__main__":
    ...
    #classifier1 = SVMClassifier('./output/question_type_classifier/svm_pt_embedding.model')
    #classifier2 = SVMClassifier('./output/double_relation_classifier/svm_pt_embedding.model')

    #classifier1 = RFClassifier('./output/question_type_classifier/rf_pt_embedding.model')
    #classifier2 = RFClassifier('./output/double_relation_classifier/rf_pt_embedding.model')

    classifier1 = NNClassifier('./output/question_type_classifier/nn_pt_embedding.model')
    classifier2 = NNClassifier('./output/double_relation_classifier/nn_pt_embedding.model')

    query_builder = Orchestrator(None, classifier1, classifier2, parser, None, auto_train=False)

    #print("train_question_classifier")

    #scores = query_builder.train_question_classifier(file_path="./data/LC-QUAD/data_pt.json", test_size=0.2)
    #print(scores)
