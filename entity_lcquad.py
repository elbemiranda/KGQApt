...
if __name__ == "__main__":
    ...
    with open('data/LC-QUAD/data_pt.json', 'r', encoding='utf-8') as f:
        data = json.load(f)
    ...
    with open(f'data/LC-QUAD/entity_lcquad-{experiment}.json', "w", encoding="utf-8") as data_file:
