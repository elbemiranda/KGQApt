...
if __name__ == "__main__":
    ...
    linker = Earl(path="data/LC-QUAD/entity_lcquad-without_ptrl.json")
    ...
    #output = None
    #with open('output/lcquadanswer_output-without_ptrl.json', 'r', encoding="utf-8") as data_file:
    #    output = json.load(data_file)
    #ids = [item['id'] for item in output]   
    qnt = len(ds.qapairs)
    for qapair in ds.qapairs:
        #if not qapair.id in ids:
        stats.inc("total")
