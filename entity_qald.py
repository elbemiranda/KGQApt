...
#    with open('data/QALD/entity_qald - v1.json', 'r', encoding='utf-8') as f:
#        qald_entities = json.load(f)
    ...
    with open(f'data/QALD/entity_qald-{experiment}.json', "w", encoding= "utf-8") as data_file:
